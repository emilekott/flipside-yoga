		...
		<tbody>
			...
			?>
				<tr>
					...
					<td>
						<a class="greenbutton" href='<?php echo $editSlidesLink ?>'>Edit Slides</a>
						...
						<span class="hor_sap"></span>
						<a id="button_duplicate_<?php echo $id?>" href='javascript:void(0)' class="button-secondary button_duplicate_slider">Duplicate</a>
					</td>
