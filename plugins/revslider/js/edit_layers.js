...
//======================================================
	...
	var initHtmlFields = function(){
		...
		jQuery(".ui-autocomplete, #layer_caption").click(function(event){
			event.stopPropagation();
		});
...
//======================================================
	...
	var disableFormFields = function(){
		...
		jQuery("#form_layers .setting_text, #form_layers .setting_unit").addClass("text-disabled");
	...
	var enableFormFields = function(){
		...
		jQuery("#form_layers .setting_text, #form_layers .setting_unit").removeClass("text-disabled");
	...
	var updateLayerFormFields = function(serial){
		...
		jQuery("#layer_video_autoplay").val(objLayer.video_autoplay);
	...
	var setLayerSelected = function(serial){
		...
		switch(objLayer.type){
			case "video":	//show edit video button
				...
				jQuery("#layer_video_autoplay_row").show();
