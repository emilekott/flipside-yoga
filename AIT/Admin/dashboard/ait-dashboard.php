...
<?php function aitThemeUpdates() {
	...
	if(!empty($versions)):
		...
		<p><input type="checkbox" <?php echo $disableUpdatesNotifying ? 'checked' : ''; ?> data-ait-is-update-available="<?php echo $isUpdateAvailable; ?>" id="disableUpdatesNotifications" name="disableUpdatesNotifications"> <label for="disableUpdatesNotifications"><?php _e("Disable theme updates notifications."); ?></label></p>
	<?php else:	?>
