         ...
         <?php while (have_posts()): the_post();
            ...
            ?>
                ...
                <?php if ( has_post_thumbnail ( get_the_ID() ) && $instance['show_thumbnails'] ) : ?>
                    ...
                    <div class="thumb-wrap <?php echo $thumbnail_class; ?>">
                        ...
                        <a href="<?php the_permalink(); ?>" class="greyscale">
                            <img class="thumb" src="<?php echo get_template_directory_uri(); ?>/AIT/Framework/Libs/timthumb/timthumb.php?src=<?php echo $thumbnail_args['0']; ?>&amp;w=<?php echo $instance['thumbnail_width']; ?>&amp;h=<?php echo $instance['thumbnail_height']; ?>" alt="" />
                        </a>
                    </div><!-- /.thumb-wrap -->
                <?php endif; ?>
                ...
                <div class="read-more">
                    ...
                    <small class="fr">
                        <a href="<?php the_permalink(); ?>"><?php echo __('read more',"ait-theme"); ?></a>
                    </small>
                </div>
                <?php endif; ?>
            </div><!-- /.item -->
