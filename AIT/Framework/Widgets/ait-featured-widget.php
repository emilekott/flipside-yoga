 ...
 */
	function Featured_Widget () {
		...
		$widget_ops = array (
			...
			'description' => __('Insert a featured item')
		);

		/* Create the widget */
		$this->WP_Widget('featured-widget', __('Theme &rarr; Featured Item'), $widget_ops);
	}
 ...
 */
    ...
    <p>
			<label for="<?php echo $this->get_field_id( 'item_type' ); ?>"><?php echo __( 'Item type' ); ?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'item_count' ); ?>"><?php echo __( 'Item count' ); ?>:</label>
    ...
    <p>
			<label for="<?php echo $this->get_field_id( 'item_order' ); ?>"><?php echo __( 'Item order' ); ?>:</label>
      ...
      <?php $checked = ''; if ( $instance['item_ignoreFeatured'] ) $checked = 'checked="checked"'; ?>
			...
			<label for="<?php echo $this->get_field_id( 'item_ignoreFeatured' ); ?>"><?php echo __( 'Ignore featured property' ); ?></label>
    </p>
		<?php
	}
}
