 ...
 */
	function Soundcloud_Widget () {
		...
		$widget_ops = array (
			...
			'description' => __('Display soundcloud player')
		);

		/* Create the widget */
		$this->WP_Widget('soundcloud-widget', __('Theme &rarr; Soundcloud'), $widget_ops);
	}
...
?>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'player_artwork' ); ?>"><?php echo __( 'Show artwork' ); ?>:</label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'player_color' ); ?>"><?php echo __( 'Player color' ); ?>:</label>
