 ...
 */
	function Album_Widget () {
		...
		$widget_ops = array (
			...
			'description' => __('Display album info')
		);

		/* Create the widget */
		$this->WP_Widget('album-widget', __('Theme &rarr; Album'), $widget_ops);
	}
...
?>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'widget_album' ); ?>"><?php echo __( 'Album' ); ?>:</label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'player_autoplay' ); ?>"><?php echo __( 'Autoplay' ); ?>:</label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'player_loop' ); ?>"><?php echo __( 'Loop' ); ?>:</label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'player_shuffle' ); ?>"><?php echo __( 'Shuffle' ); ?>:</label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'player_controls' ); ?>"><?php echo __( 'Display Controls' ); ?>:</label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'player_playlist' ); ?>"><?php echo __( 'Display Playlist' ); ?>:</label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'player_download' ); ?>"><?php echo __( 'Display Download Link' ); ?>:</label>
