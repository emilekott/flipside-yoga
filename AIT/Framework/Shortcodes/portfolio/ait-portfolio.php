...
function ait_portfolio( $params ) {
	...
	if($cat_id != '') {
		...
		$args = array( 'numberposts' => 500, 'post_type' => 'ait-portfolio', 'orderby' => 'menu_order', 'order' => 'ASC', 'suppress_filters' => false, 'tax_query' => array( array( 'taxonomy' => 'ait-portfolio-category', 'field' => 'slug', 'terms' => $slug) ) );
  }
