		...
		tinymce.create('tinymce.plugins.ait_shortcodes_<?php echo $_REQUEST['plugin']; ?>', {
			init : function(ed, url) {
				...
				ed.addCommand('ait_shortcodes_<?php echo $_REQUEST['plugin']; ?>', function() {
					...
					tb_show('<?php echo $title; ?>', '<?php echo THEME_URL; ?>/AIT/Framework/Shortcodes/popupWindow.php?plugin=<?php echo $_REQUEST['plugin']; ?>&width=<?php echo $width; ?>&height=<?php echo $height; ?>');
